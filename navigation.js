...
(function () {
  ...
  if (undefined == menu) {
    ...
    if (!menu.childNodes.length) button.style.display = "none";
  }
  ...
  if (undefined == menusub) {
    ...
    // Hide menu toggle button if menu is empty.
    if (!menusub.childNodes.length) buttonsub.style.display = "none";
  }
})();
